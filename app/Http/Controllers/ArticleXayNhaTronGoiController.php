...
class ArticleXayNhaTronGoiController extends Controller
{
...
//        }
    ...
    public function create()
    {
        ...
        return view('admin/article_xay_nha_tron_goi/create', ['categories' => $categories]);
    }
...
//            'scale' => 'required',
        ...
        $article->save();
//        $conditionView = 'index';
        return redirect()->route('article_xay_nha_tron_goi.index')->with('success', 'Tạo bài viết thành công!');
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where('type',6)->get();
        return view('admin/article_xay_nha_tron_goi/edit', ['article' => $article, 'categories' => $categories]);
    }
...
//            'scale' => 'required',
        ...
        $article->save();
        $conditionView = 'index';
        return redirect()->route('article_xay_nha_tron_goi.index')->with('success', 'Thay đổi bài viết thành công !');
    }
