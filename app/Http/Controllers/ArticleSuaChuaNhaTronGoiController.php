...
class ArticleSuaChuaNhaTronGoiController extends Controller
{
...
//        }
        $query->whereHas('category', function ($query) {
            $query->where('type', 7)->orderBy('created_at', 'desc');
        });
        ...
        return view('admin.article_sua_chua_nha_tron_goi.index',
            compact('articles', 'conditionView' , 'paginate', 'searchType', 'conditionView'));
    }

    public function create()
    {
        $categories = Category::where('type', 7)->get();
        return view('admin/article_sua_chua_nha_tron_goi/create', ['categories' => $categories]);
    }
...
//            'scale' => 'required',
        ...
        $article->save();
//        $conditionView = 'index';
        return redirect()->route('article_sua_chua_nha_tron_goi.index')->with('success', 'Tạo bài viết thành công!');
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where('type',7)->get();
        return view('admin/article_sua_chua_nha_tron_goi/edit', ['article' => $article, 'categories' => $categories]);
    }
...
//            'scale' => 'required',
        ...
        $article->save();
        $conditionView = 'index';
        return redirect()->route('article_sua_chua_nha_tron_goi.index')->with('success', 'Thay đổi bài viết thành công !');
    }
