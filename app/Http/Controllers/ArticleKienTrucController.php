...
class ArticleKienTrucController extends Controller
{
...
//        }
    ...
    public function create()
    {
        ...
        return view('admin/article_kientruc/create', ['categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $article->save();
//        $conditionView = 'index';
        return redirect()->route('article_kien_truc.index')->with('success', 'Tạo bài viết thành công!');
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where('type',2)->get();
        return view('admin/article_kientruc/edit', ['article' => $article, 'categories' => $categories]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $article->save();
        $conditionView = 'index';
        return redirect()->route('article_kien_truc.index')->with('success', 'Thay đổi bài viết thành công !');
    }
