...
class ArticleVimarController extends Controller
{
...
//        }
    ...
    public function create()
    {
        ...
        return view('admin/article_vimar/create', ['categories' => $categories]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $article->save();
//        $conditionView = 'index';
        return redirect()->route('article_vimar.index')->with('success', 'Tạo bài viết thành công!');
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where('type',5)->get();
        return view('admin/article_vimar/edit', ['article' => $article, 'categories' => $categories]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $article->save();
        $conditionView = 'index';
        return redirect()->route('article_vimar.index')->with('success', 'Thay đổi bài viết thành công !');
    }
