...
{{--                    @endif--}}
                ...
                @if($conditionView === 'index')
                    <td class="col-lg-1">
                        <a href="{{route('article_noi_that.edit',[ $article->id ])}}" class="btn btn-warning">
                            Sửa
                            <i class="fa fa-magic" aria-hidden="true"></i>
                        </a>
                    </td>
                    <td class="col-lg-1">
                        <form action="{{route('article_noi_that.destroy',[ $article->id ])}}" method="POST" id="delete-article">
                            @csrf
                            @method('DELETE')
