...
{{--                    @endif--}}
                ...
                @if($conditionView === 'index')
                    <td class="col-lg-1">
                        <a href="{{route('article_sua_chua_nha_tron_goi.edit',[ $article->id ])}}" class="btn btn-warning">
                            Sửa
                            <i class="fa fa-magic" aria-hidden="true"></i>
                        </a>
                    </td>
                    <td class="col-lg-1">
                        <form action="{{route('article_sua_chua_nha_tron_goi.destroy',[ $article->id ])}}" method="POST" id="delete-article">
                            @csrf
                            @method('DELETE')
