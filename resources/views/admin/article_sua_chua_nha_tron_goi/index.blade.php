...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="">
                <form method="GET" action="{{ route('article_xay_nha_tron_goi.index',['conditionView' => $conditionView]) }}" class="row g-3 mb-4">
                    <div class="col-md-2">
            ...
            @include('admin/article_sua_chua_nha_tron_goi/index/page',compact('articles','conditionView'))
        </div>
    </div>
@endsection
