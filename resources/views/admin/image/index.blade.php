...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Danh sách ảnh') }}</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="">
                <form method="GET" action="{{ route('images.index') }}" class="row g-3 mb-4">
                    <div class="col-md-2">
            ...
            @include('admin/image/index/page',compact('images'))
        </div>
    </div>
@endsection
