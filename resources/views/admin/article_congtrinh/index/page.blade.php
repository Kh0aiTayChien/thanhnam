...
{{--                    @endif--}}
                ...
                @if($conditionView === 'index')
                    <td class="col-lg-1">
                        <a href="{{route('article_cong_trinh.edit',[ $article->id ])}}" class="btn btn-warning">
                            Sửa
                            <i class="fa fa-magic" aria-hidden="true"></i>
                        </a>
                    </td>
                    <td class="col-lg-1">
                        <form action="{{route('article_cong_trinh.destroy',[ $article->id ])}}" method="POST" id="delete-article">
                            @csrf
                            @method('DELETE')
