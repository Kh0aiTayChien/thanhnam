<div class="section-1 d-flex flex-column position-relative">
    <div id="section-1-carousel"
        ...
        <div class="d-flex align-content-center justify-content-center position-absolute"
             style="z-index: 200; bottom: 33vh; margin: 0 20vh">
        ...
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#section-1-carousel" data-bs-slide-to="1"
                    aria-label="Slide 2"></button>
            <button type="button" data-bs-target="#section-1-carousel" data-bs-slide-to="2"
