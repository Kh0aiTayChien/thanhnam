<div class="section-3 d-flex align-items-center justify-content-center" id="lien-he">
    <form action="" class="p-4 shadow-effect border-radius" style="height: 60%;"  data-aos="fade-up" data-aos-duration="1500">
        <img src="{{'images/homepage/section-3/form-title.png'}}" alt="" class="img-fluid mb-3" style="scale: 80%; transform: translateY(8%)">
        <div class="mb-4 mt-2">
            <input type="text" class="form-control montserrat-semibold" id="name" name="name" placeholder="Họ và tên" >
        </div>
        <div class="mb-4 mt-4">
            <input type="number" class="form-control montserrat-semibold" id="phone" name="phone" placeholder="Số điện thoại">
        </div>
        <textarea class="form-control mb-4 mt-3 montserrat-semibold" name="care"
