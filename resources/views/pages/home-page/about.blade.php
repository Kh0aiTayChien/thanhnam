<div class="about-section mb-5 d-none d-md-block">
    <div class="d-flex justify-content-center align-content-center mb-5" data-aos="fade-down" data-aos-duration="1000">
        <img src="{{asset('images/homepage/about/title.png')}}" alt="">
    </div>

    <div class=" row-test">
        <img src="{{asset('images/homepage/about/about.png')}}" class="col-xxl-4 imgsec2-HP-test img-fluid" alt="" data-aos="fade-right" data-aos-duration="1000">
        <div class="col-xxl-4 col-md-12 containercontentsec2-HP">
            <p class="contentsec2-HP-test mulish-semibold" data-aos="fade-left" data-aos-duration="1000"> Công ty TNHH kỹ thuật và thương mại Thành Nam thành lập vào tháng 11 năm 2019. Hoạt động
