<div class=" sec-read justify-content-center">
    <div class="row-test banner-pools">
        <p class="" style="font-family: Mulish-ExtraBold, sans-serif; color: white; font-size: 30px">THI CÔNG CÔNG TRÌNH</p>
    </div>
    @foreach($news as $article)
        <div class="content1-pools">
            <div class="text-pools">
                <p class="text-center h3"><span style="font-weight: bold"></span> {{$article->title}}</p>
