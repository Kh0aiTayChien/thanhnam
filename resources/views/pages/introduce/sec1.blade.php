...
<div class="sec1-GT">
    <img src="{{asset('images/introduce/sec1/Sec3_1.png')}}" class="d-none d-md-block col-12">
...
<div class="sec1-GT">
    ...
    <img src="{{asset('images/introduce/sec1/Asset 11.png')}}" class="d-block d-md-none col-12 imgsec5-GT-mb">
</div>
